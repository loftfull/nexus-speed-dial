...
**Важная оговорка.** Шрифт грузится с Google Fonts, а в этой среде домен
закрыт прокси. Значит, ни я, ни CI ни разу не видели приложение в его
настоящей гарнитуре — все снимки сделаны системным запасным шрифтом.
Насколько Inter изменит вид у реального пользователя, я подтвердить не могу.
