...
export async function runVisualQa(root) {
  ...
  add(checks, failures, 'preferences-live-visuals', ['data-theme','data-density','data-background','data-glass'].every(token => prefBridge.includes(token)) && ["data-theme='dark'","data-background='contrast'","data-density='compact'","data-glass='strong'"].every(token => globalCss.includes(token)), 'Theme/background/density/glass preferences must alter live visuals');
