...
export async function runVisualQa(root) {
  const checks = [];
  const failures = [];
  const [helpers, config, visual, tileCss, dockCss, previewCss, sidebar, workspace, workspaceCss, omnibox, siteEditorCss, structureEditorCss, weatherCss] = await Promise.all([
