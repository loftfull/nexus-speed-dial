...
export function AddSiteModal({onClose,onSave,existing,categories,allowRemoteMetadata=false}:{onClose:()=>void;onSave:(site:Site)=>void;existing?:Site;categories:string[];allowRemoteMetadata?:boolean}){
